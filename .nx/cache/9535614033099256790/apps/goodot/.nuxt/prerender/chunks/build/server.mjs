import { version, unref, inject, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, resolveComponent, useSSRContext, createApp, effectScope, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, computed, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, shallowRef, isReadonly, withCtx, createTextVNode, isRef, isShallow, isReactive, toRaw } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/ofetch/dist/node.mjs';
...
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, isScriptProtocol, withQuery, withTrailingSlash, withoutTrailingSlash } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/debian/goodot/nuxt/goodot/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-ZxZgZibE.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CYjLYDao.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-f1ca065e><header data-v-f1ca065e><nav data-v-f1ca065e>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f1ca065e"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DHLl3XLm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BtHr43rq.mjs'));
