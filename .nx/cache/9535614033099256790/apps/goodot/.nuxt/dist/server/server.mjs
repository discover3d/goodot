import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, resolveComponent, computed, provide, watch, Suspense, nextTick, Fragment, Transition, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-ZxZgZibE.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CYjLYDao.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DHLl3XLm.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BtHr43rq.js"));
