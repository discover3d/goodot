...
const addRepository$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: addRepository
});
...
const greet$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: greet
});

const repositories = defineEventHandler(async (event) => {
  const repositories = await prisma.repository.findMany();
  return repositories;
});

const repositories$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
